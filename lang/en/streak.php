...
$string['settings:defaults'] = 'Site-wide streak settings';
$string['settings:freezecap'] = 'Maximum freezes';
$string['settings:freezecap_help'] = 'The largest number of unused freezes a learner can hold at once. Once they reach this cap, no further freezes accrue until one is used.';
$string['settings:freezerate'] = 'Freeze accrual rate';
$string['settings:freezerate_help'] = 'A learner earns one streak freeze for every this many successful periods, up to the maximum below. A freeze automatically forgives a single missed period, so an occasional gap does not reset the streak. Enter 0 to switch freezes off.';
$string['settings:reminderhour'] = 'Reminder hour';
$string['settings:reminderhour_help'] = 'The hour of day (0-23) at which the daily check for at-risk streaks runs and make-or-break reminders are sent. Learners cannot choose their own hour. They can only turn these reminders off altogether, in their own notification preferences. Delivery also respects quiet hours.';
