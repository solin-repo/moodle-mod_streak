...
$string['modfilterexclude_help'] = 'One activity-module name per line (for example "forum") to leave out when deciding whether a learner practiced. Only applies when a day is earned by any activity completion.';
$string['modulename'] = 'Solin Streaks';
$string['modulename_help'] = 'Solin Streaks adds a regular-practice learning streak to a course: a per-learner streak counter, streak freezes, reminders, and a per-course leaderboard. The rhythm is yours to choose: every day, or a number of days per week, fortnight or month.';
...
$string['rewardbreaks_help'] = 'Normally a holiday or a day that does not count is simply skipped, and the streak neither grows nor breaks. Switch this on to let a learner who practices anyway grow their streak on such a day.';
...
$string['settings:reminderhour_help'] = 'The hour of day (0-23) from which a learner may be told their streak is at risk, read in the learner\'s own timezone. The check itself runs every hour; this setting decides how early in the day a reminder may go out. Learners cannot choose their own hour. They can only turn these reminders off altogether, in their own notification preferences. This is the starting value for a new activity; each activity can change it, and changing this setting does not affect activities that already exist.';
